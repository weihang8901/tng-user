...
public interface UserService {
     ...
     * @return
     */
    @GetMapping(value = "/userinfo/users-anon/login", params = "username")
     ...
     * @return
     */
    @GetMapping(value = "/userinfo/users-anon/mobile", params = "mobile")
     ...
     * @return
     */
    @GetMapping(value = "/userinfo/users-anon/openId", params = "openId")
    LoginAppUser findByOpenId(@RequestParam("openId") String openId);

    /**
     * feign rpc访问远程/userinfo/{username}接口
     * 查询用户实体对象UserInfo
     *
     * @param username
     * @return
     */
    @GetMapping(value = "/userinfo/users/{username}")
    UserInfo selectByUsername(@PathVariable("username") String username);
     ...
     * @return
     */
    @PostMapping(value = "/userinfo/users/saveOrUpdate")
